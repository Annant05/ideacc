...
<p> Select class    </p>
    <select name="class">
    <option value="CS1_3rd ">CS1 3rd year</option>
    <option value="CS1_3rd ">CS2 3rd year</option>
    <option value="CS1_3rd ">CS3 3rd year</option>
    <option value="CS1_3rd">CS4 3rd year</option>
    </select>
    <br>
    <br>
...
if ($filesize < 100 && $filesize< 2000000){
 ...
 if($errors==0){
  ...
  if($uplaod_success==TRUE){
   ...
   $result=mysqli_query($conn,"INSERT INTO assignment (name,size,type,class)VALUES('$name','$size','$type','$classid')");
      
   if($result==TRUE){
    echo "\r\nYour pdf '$name' Successfully Upload and Information Saved Our Database";
   }
 }
}
}
