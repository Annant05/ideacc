...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<div>
			...
			<input id="element_2" name="response" class="element textarea small" type="radio"  value=""><?php echo $a1 ;?><br>
		</div> 
		</li>		<li id="li_3" >
		<label class="description" for="element_3">Option B </label>
		<div>
			<input id="element_3" name="response" class="element textarea small" type="radio"  value=""><?php echo $a2 ;?><br> 
		</div> 
		</li>		<li id="li_4" >
		<label class="description" for="element_4">Option C </label>
		<div>
			<input id="element_4" name="response" class="element textarea small" type="radio" value=""><?php echo $a3 ;?><br> 
		</div> 
		</li>		<li id="li_5" >
		<label class="description" for="element_5">Option D </label>
		<div>
			<input id="element_5" name="response" class="element textarea small" type="radio" value=""><?php echo $a4 ;?><br> 
		</div> 
		</li>       
